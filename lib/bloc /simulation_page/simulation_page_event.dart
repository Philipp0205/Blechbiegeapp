...
/// Unfolds plate
class SimulationPlateUnbended extends SimulationPageEvent {
  final Tool plate;

  const SimulationPlateUnbended({required this.plate});
}

/// Refolds plate
class SimulationPlateBended extends SimulationPageEvent {
  final Tool plate;
